...
I lean pretty heavily towards Pydantic Python these days (and the typed counterparts in other libraries like SQLAlchemy's  `Mapped`), but I think it's important that we are careful not to throw the duck-typed baby out with the dynamic language bathwater.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMTI3MTg5OTcsNjI3OTQ5NjM2LDU5Nz
