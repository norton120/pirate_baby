...
```
```txt
# vector similarity search results "What is the last thing Todd said before he quit yesterday?" via embeddings, appended to mp
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM3MjQ1NTA0OSwtMjEzMDY4NzU1OSwtMT
