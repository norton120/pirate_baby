...
This is remarkably similar to the premise behind [MemGPT](https://memgpt.ai/).  The context window, chat history, and RAG knowledge store are treated as "me

Instead of approaching each turn as an isolated prompt + RAG + input = response, 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NTIwMDU0NDYsMzU4MTM3OTQ1LC0yMT
