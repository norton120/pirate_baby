...
Instead of approaching each turn as an isolated prompt + RAG + input = response, the "core" memory (the context window content) is processed continually as a daemon, with a new turn on each "heartbeart." This 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNDAzNDIxMzEsMzU4MTM3OTQ1LC0yMT
