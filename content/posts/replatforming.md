...
Reflection amongst myself and the client team helped us steer clear of a ground-up replatform. Our "production replatform" became an iterative release of production features coupled with refactorings. Initially, that means only a single operation will be executed in our new framework - an operation that is trivial to implement in the new framework, but very complex and difficult in the legacy platform. Once successful, we will address individual operations lacking in performance, test coverage and observability with small, precision refactorings. These may result in our porting some other operations to the new framework, where the end result will be cleaner, more performant, more maintainable code. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc5MTk5MzA4NywxOTk0NTcwNjA1LDg1OD
A1OTAwNyw4OTM4MjMyMiwxMTgyNjU3NTU3LC0yMjc2ODEwNDAs
LTE1MzIyMzI5MDIsLTE2NjQ3MjY3ODQsLTM3MDc4MDEwNywtMT
