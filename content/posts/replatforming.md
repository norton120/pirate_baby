...
The exact boundries of what would constitute a replatform are a bit fuzzy, and the distinction between a replato. In theory, a replatform is the decision to tear down or replace existing software with something entirely new. That could be a new software framework, a totally new architecture, or different software language entirely. This would be analogous to bulldozing a derelict building and constructing a new one where it stood. 
But 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMjc2ODMyOTAsNzA4OTQxOTQ4XX0=
-->