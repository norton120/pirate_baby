...
This can be a difficult thing for teams (and stakeholders) to wrap their heads around at first; the larger the list of failing cases you have identified, accounted and corrected for, the closer you are to a commerically viable product. This process is hard, nessesary work, and the process presents a unique danger; if you (or your stakeholders) mistook your initial "happy path demo" for a completed product, then each of these succ
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3MDg5OTQ1MzQsLTE4Mzg5NTE0NjcsLT
