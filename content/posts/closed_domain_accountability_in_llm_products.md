...
If I am allowed to facepalm my response to only one single pattern in the GenAI craze, this would be it. Somewhere along the way it was decided that AI/ML technology is "off limits" to everyone on th
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3Njk1Nzc3NzcsLTE5ODAxOTM2NjgsLT
