...
Ironically, there is a ridiculously simple way to validate . If you want to test if users will engage with an online billing platform or a new recommendations engine, you pretty much have to build the thing. But 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3ODMwNjYxNzIsLTE5ODAxOTM2NjgsLT
