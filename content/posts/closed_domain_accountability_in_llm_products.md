...
If I am allowed to facepalm my response to only one single pattern in the GenAI craze, this would be it. Somewhere along the way it was decided that AI/ML is "off limits" to everyone in 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIzNzM1MjA1OSwtMTk4MDE5MzY2OCwtND
