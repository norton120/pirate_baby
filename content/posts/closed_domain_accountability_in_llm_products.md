...
One of my favorite productivity tools added an AI-powered filter builder about a month ago. Instead of typing the filter code `(tomorrow | next+week)`, I can now type `show me events that are scheduled for tomorrow or next week`.  Then the assistant chugs for about 10 seconds, and replaces my natural language text with `(tomorrow | next+week)`.  It's a cute novelty, but the filter already had typing hints - this is slower and requires more typing than the product they already offered. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE5OTk2Mzk5OSw5OTkwNTE5MTUsLTE3OD
