...
Experiments report metrics - how many test cases remain, how the scores are trending, and if the hypothesis under test is a statistical improvement. Playgrounds generate updates like "I am still working on X" and "Y seems a little better now." This importance of this difference is magnified when you understand that the immediate goal of experimentation is not feature success, but _systematic understanding_ that will lead to feature success. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAxNTk3MzM4MSwtMTYxNTc2NjQzLDEyOD
