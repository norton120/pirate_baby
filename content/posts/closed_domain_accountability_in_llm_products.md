...
Ironically, the nature of many AI products - especially natural language products - makes them remarkably easy to validate. Whereas testing engagement with an online billing platform or a new recommendations engine pretty much requires you to build the thing first, GenAI products are typically emulating humans. So... _first, use a human_. In an act of [doing things that do not scale](https://paulgraham.com/ds.html), releasing a human-powered prototype is a brilliantly simple way to determine if the product will actually add value. The Product and UX designs translate 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM5MzQ0MDk2NSw5OTkwNTE5MTUsLTE3OD
